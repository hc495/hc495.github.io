...
```json
{
    ...
    "tasks": [
        ...
        "command": "D:/application/mingw64/bin/g++.exe",   // 要使用的编译器，C++用g++
        "args": [
            "${file}",//当前文件名
            ...
            // -L 库文件目录
            // -l 库文件
            "-I", "D:/application/opencv4.5.3_bulid/install/include",
            "-I", "D:/application/opencv4.5.3_bulid/install/include/opencv2",
            "-L", "D:/application/opencv4.5.3_bulid/install/x64/mingw/lib",
