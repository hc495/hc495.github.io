...
- Chapter 4: [Mechanism of Task-oriented Information Removal in In-context Learning](https://openreview.net/forum?id=VAv1rrPR1A){:target="_blank"} (ICLR 2026) [h5=362, IF=48.9, Core A*]
